...
public class fpenjualan extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        penjualan sale = new penjualan();
        sale.setIdPenjualan(txt1.getText());
        sale.setNoPenjualan(Integer.valueOf(txt3.getText()));
        sale.setIdUser(txt3.getText());
        sale.setTotal(Integer.valueOf(txt4.getText()));
        sale.setBayar(Integer.valueOf(txt5.getText()));
        sale.infoSale();
